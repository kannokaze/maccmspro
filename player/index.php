...
<head>
    ...
    if (strpos($_GET['url'], 'm3u8')) {
        echo '<script src="https://cdn.jsdelivr.net/npm/cdnbye@1.7.2/dist/hls.min.js"></script>';
    } elseif (strpos($_GET['url'], 'flv')) {
        echo '<script src="https://cdn.jsdelivr.net/npm/flv.js@1.5.0/dist/flv.min.js"></script>';
    }
    ?>
